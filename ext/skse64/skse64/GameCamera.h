...
public:
	...
	DEFINE_MEMBER_FN(SetCameraState, UInt32, 0x005511C0, TESCameraState * cameraState);
};
...
public:
	...
	DEFINE_MEMBER_FN(ctor, void, 0x00242550);
	DEFINE_MEMBER_FN(SetNorthRotation, void, 0x002429A0, float northRotation);
};
...
public:
	...
	static PlayerCamera *	GetSingleton(void)
	{
		...
		static RelocPtr<PlayerCamera*> g_playerCamera(0x030FD7F8);
	...
	DEFINE_MEMBER_FN(UpdateThirdPerson, void, 0x008E5850, bool weaponDrawn);
};
