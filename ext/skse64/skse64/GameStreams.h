...
public:
	...
	DEFINE_MEMBER_FN(Construct, NiMemStream *, 0x014FE3A0);
	DEFINE_MEMBER_FN(Destroy, void, 0x014FE410);
	DEFINE_MEMBER_FN(Seek, void, 0x014FE4A0, SInt32);
	// ??_7NiMemStream@@6B@ + 18
	DEFINE_MEMBER_FN(GetOffset, UInt32, 0x00CE97C0, void);
	DEFINE_MEMBER_FN(CopyFrom, UInt32, 0x014FE470, void *);
	// ??_7NiMemStream@@6B@ + 28
	DEFINE_MEMBER_FN(FunctionSwap, UInt32, 0x014FE4E0, bool);
...
public:
	...
	DEFINE_MEMBER_FN(Construct, BSResourceNiBinaryStream *, 0x00D3C790, const char * filePath, UInt32 unk1, UInt32 unk2);	// unk1 = 0, unk2 = 0
	DEFINE_MEMBER_FN(ReadLine, UInt32, 0x00D3CCD0, char * dst, UInt32 dstLen, UInt32 terminator);
	
	// see ??_7BSResourceNiBinaryStream@@6B@ ctor
	DEFINE_MEMBER_FN(Read, UInt32, 0x00D3CEC0, void * dst, UInt32 len);
	DEFINE_MEMBER_FN(Write, UInt32, 0x00D3CF30, void * src, UInt32 len);
	DEFINE_MEMBER_FN(Destroy, void, 0x00D3CA70);

	DEFINE_MEMBER_FN(IsValid, bool, 0x00D3CBB0, void);
	DEFINE_MEMBER_FN(Seek, void, 0x00D3CBC0, SInt32);
	// ??_7BSResourceNiBinaryStream@@6B@ + 18
	DEFINE_MEMBER_FN(GetOffset, UInt32, 0x00D3CC00, void);	// return offset;
	// ??_7BSResourceNiBinaryStream@@6B@ + 28
	DEFINE_MEMBER_FN(EnableEndianSwap, void, 0x00D3CC90, bool);
