...
public:
	...
	DEFINE_MEMBER_FN(Get, void, 0x001DBCC0, BSString * out, TESForm * parent, UInt32 fieldType);
};
...
public:
	...
	DEFINE_MEMBER_FN_0(UpdateWeightData, void, 0x00212560);
	DEFINE_MEMBER_FN_0(DeleteThis, void, 0x00212460);
};
...
public:
	...
	DEFINE_MEMBER_FN(SetEquipFlag, void, 0x00711AC0, UInt8 flags);
	DEFINE_MEMBER_FN(UpdateEquipment, void, 0x006E3B70, Actor * actor);
	// CDC12817DF3AB5B832348763F433A216BB8A85CA+89
	DEFINE_MEMBER_FN(SetDataFlag, void, 0x006EF7D0, float flag); // Sets a number on the 0x10 object
...
public:
	...
	DEFINE_MEMBER_FN(GetSkillData, UInt32, 0x0077ADC0, UInt32 actorValue, float * level, float * points, float * pointsMax, UInt32 * unk6);
	DEFINE_MEMBER_FN(IncrementLegendary, UInt32, 0x0077B3B0, UInt32 actorValue);
	DEFINE_MEMBER_FN(SetLevel, void, 0x0077B350, UInt32 level);
};
