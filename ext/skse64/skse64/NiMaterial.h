...
public:
	...
	DEFINE_MEMBER_FN(CopyFrom, void, 0x014B73E0, BSLightingShaderMaterial * other);
	DEFINE_MEMBER_FN(dtor_base, void, 0x014B7280);
};
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x014B8D90);
};
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x014BA380);
};
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x014B9490);
};
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x014B9910);
};
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x014BBDF0);
};
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x014B9D90);
};
