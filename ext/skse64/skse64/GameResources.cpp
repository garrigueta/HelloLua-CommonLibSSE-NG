...
FaceGenTriDatabase * FaceGenTriDatabase::GetSingleton(void)
{
	...
	static RelocPtr<FaceGenTriDatabase*> g_FaceGenTriDatabase(0x031394E0);
...
BSFaceGenDB::TRI::DBTraits::Data * FaceGenTriDatabase::GetInvalidEntry(void)
{
	...
	static RelocPtr<BSFaceGenDB::TRI::DBTraits::Data> g_FaceGenTriDatabase_InvalidEntry(0x02012FA8);
